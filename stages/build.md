...
Before writing anything, find where the repository keeps committed placeholder material (an `examples/` tree, committed test fixtures) and put new placeholders there. A path the repository ignores is ignored for a reason; do not work around it.
